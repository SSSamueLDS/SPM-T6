    ...
    <div class="SkillsView container">
        <div class = "row">
            ...
            <div class="col-5 m-0 col-sm-5 col-md-6 col-lg-3 col-xl-2">
                <a href="add_skill.html" class="btn btn-dark w-100 m-2" style="color: greenyellow; font-weight: bold;">ADD NEW SKILL</a>
            </div>
            <!-- SEARCH BAR -->
            <div class="col-5 d-flex align-items-center col-sm-7 col-md-6 col-lg-9 col-xl-10">
                <form class="form-inline d-flex w-100">
                    <div class = "input-group">
                        <input class="form-control mr-2 flex-grow-1" type="search" placeholder="Search" aria-label="Search">
        ...
        <div class="row justify-content-start">
            <div class="dropdown col-12">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" @click="sort_alphabetically">Alphabetically (A to Z)</a></li>
                </ul>
            </div>
        </div>
        ...
        <div v-if="database_error==false">
            ...
            <nav aria-label="Skill page navigation">
                <ul class="pagination">
                    <li class="page-item"><a class="page-link text-black" @click="go_previous_page()">Previous</a></li>
                    <li class="page-item" v-for="i in grouped_skills.length"><a class="page-link text-black" @click="go_page(i)">{{i}}</a></li>
                    <li class="page-item"><a class="page-link text-black" @click="go_next_page()">Next</a></li>
                </ul>
                </nav>
        </div>
        ...
        <div class="alert alert-danger mt-3" role="alert" v-else>
            ...
            <p>There was an error loading the skills from the database. Please try again later.</p>
        </div>
